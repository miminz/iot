...
../agile_modbus-1.1.3/util/bits.c \
../agile_modbus-1.1.3/util/input_bits.c \
../agile_modbus-1.1.3/util/input_registers.c \
../agile_modbus-1.1.3/util/registers.c 

OBJS += \
./agile_modbus-1.1.3/util/agile_modbus_slave_util.o \
./agile_modbus-1.1.3/util/bits.o \
./agile_modbus-1.1.3/util/input_bits.o \
./agile_modbus-1.1.3/util/input_registers.o \
./agile_modbus-1.1.3/util/registers.o 

C_DEPS += \
./agile_modbus-1.1.3/util/agile_modbus_slave_util.d \
./agile_modbus-1.1.3/util/bits.d \
./agile_modbus-1.1.3/util/input_bits.d \
./agile_modbus-1.1.3/util/input_registers.d \
./agile_modbus-1.1.3/util/registers.d 


# Each subdirectory must supply rules for building sources it contributes
agile_modbus-1.1.3/util/%.o: ../agile_modbus-1.1.3/util/%.c
