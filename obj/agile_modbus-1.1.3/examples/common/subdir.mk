...
C_SRCS += \
../agile_modbus-1.1.3/examples/common/ringbuffer.c \
../agile_modbus-1.1.3/examples/common/rt_tick.c \
../agile_modbus-1.1.3/examples/common/serial.c \
../agile_modbus-1.1.3/examples/common/tcp.c 

OBJS += \
./agile_modbus-1.1.3/examples/common/ringbuffer.o \
./agile_modbus-1.1.3/examples/common/rt_tick.o \
./agile_modbus-1.1.3/examples/common/serial.o \
./agile_modbus-1.1.3/examples/common/tcp.o 

C_DEPS += \
./agile_modbus-1.1.3/examples/common/ringbuffer.d \
./agile_modbus-1.1.3/examples/common/rt_tick.d \
./agile_modbus-1.1.3/examples/common/serial.d \
./agile_modbus-1.1.3/examples/common/tcp.d 


# Each subdirectory must supply rules for building sources it contributes
agile_modbus-1.1.3/examples/common/%.o: ../agile_modbus-1.1.3/examples/common/%.c
