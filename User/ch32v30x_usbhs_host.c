...
UINT8   HubGetPortStatus( UINT8 HubPortIndex )
{
    ...
    s = HostCtrlTransfer( RxBuffer, &len );         // 执行控制传输
    if ( s != ERR_SUCCESS )
    {
        return( s );
    }
